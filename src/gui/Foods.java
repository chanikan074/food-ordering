...
public class Foods extends JPanel {
    ...
    Foods(){
        ...
        img1 = new JLabel(new ImageIcon("src/images/Foods/Ebi Katsu Bento.png"));
        img2 = new JLabel(new ImageIcon("src/images/Foods/Ebi Katsu don.png"));
        img3 = new JLabel(new ImageIcon("src/images/Foods/Ebi Katsu  Curry.png"));
        img4 = new JLabel(new ImageIcon("src/images/Foods/Ikura Sushipng.png"));
        img5 = new JLabel(new ImageIcon("src/images/Foods/Salmon Tuffle Sushi.png"));
        img6 = new JLabel(new ImageIcon("src/images/Foods/Unagi Sushi.png"));
        img7 = new JLabel(new ImageIcon("src/images/Foods/Salmon don.png"));
        img8 = new JLabel(new ImageIcon("src/images/Foods/Katsu don.png"));
        img9 = new JLabel(new ImageIcon("src/images/Foods/Salmon and Tobiko don.png"));

        lbl1 = new JLabel("Ebi Katsu Bento", SwingConstants.CENTER);
        lbl2 = new JLabel("Ebi Katsu don", SwingConstants.CENTER);
        lbl3 = new JLabel("Ebi Katsu Curry", SwingConstants.CENTER);
        lbl4 = new JLabel("Ikura Sushipng", SwingConstants.CENTER);
        lbl5 = new JLabel("Salmon Tuffle Sushi", SwingConstants.CENTER);
        lbl6 = new JLabel("Unagi Sushi", SwingConstants.CENTER);
        lbl7 = new JLabel("Salmon don", SwingConstants.CENTER);
        lbl8 = new JLabel("Katsu don", SwingConstants.CENTER);
        lbl9 = new JLabel("Salmon and Tobiko don", SwingConstants.CENTER);

        getLbl1().setToolTipText("Ebi Katsu Bento");
        getLbl2().setToolTipText("Ebi Katsu don");
        getLbl3().setToolTipText("Ebi Katsu Curry");
        getLbl4().setToolTipText("Ikura Sushipng");
        getLbl5().setToolTipText("Salmon Tuffle Sushi");
        getLbl6().setToolTipText("Unagi Sushi");
        getLbl7().setToolTipText("Salmon don");
        getLbl8().setToolTipText("Katsu don");
        getLbl9().setToolTipText("Salmon and Tobiko don");

        getImg1().setToolTipText("Ebi Katsu Bento");
        getImg2().setToolTipText("Ebi Katsu don");
        getImg3().setToolTipText("Ebi Katsu Curry");
        getImg4().setToolTipText("Ikura Sushipng");
        getImg5().setToolTipText("Salmon Tuffle Sushi");
        getImg6().setToolTipText("Unagi Sushi");
        getImg7().setToolTipText("Salmon don");
        getImg8().setToolTipText("Katsu don");
        getImg9().setToolTipText("Salmon and Tobiko don");
