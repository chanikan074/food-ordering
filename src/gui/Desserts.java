...
public class Desserts extends JPanel {
    ...
    Desserts(){
        ...
        img1 = new JLabel(new ImageIcon("src/images/Desserts/Black Truffle Roll.png"));
        img2 = new JLabel(new ImageIcon("src/images/Desserts/Cocorice Roll.png"));
        img3 = new JLabel(new ImageIcon("src/images/Desserts/Kanom\u200B Thai\u200B Roll.png"));
        img4 = new JLabel(new ImageIcon("src/images/Desserts/Yuzu\u200B Soft\u200B Cream.png"));
        img5 = new JLabel(new ImageIcon("src/images/Desserts/Matcha Zero Soft\u200B Cream.png"));
        img6 = new JLabel(new ImageIcon("src/images/Desserts/Milk Zero\u200B Soft\u200B Cream.png"));
        img7 = new JLabel(new ImageIcon("src/images/Desserts/Organic Chocolate Cookie.png"));
        img8 = new JLabel(new ImageIcon("src/images/Desserts/Yuzu Miso Cookie.png"));
        img9 = new JLabel(new ImageIcon("src/images/Desserts/Kinako Cookie.png"));

        lbl1 = new JLabel("Black Truffle Roll", SwingConstants.CENTER);
        lbl2 = new JLabel("Cocorice Roll", SwingConstants.CENTER);
        lbl3 = new JLabel("Kanom Thai Roll", SwingConstants.CENTER);
        lbl4 = new JLabel("Yuzu Soft Cream", SwingConstants.CENTER);
        lbl5 = new JLabel("Matcha Zero Soft Cream", SwingConstants.CENTER);
        lbl6 = new JLabel("Milk Zero Soft Cream", SwingConstants.CENTER);
        lbl7 = new JLabel("Organic Chocolate Cookie", SwingConstants.CENTER);
        lbl8 = new JLabel("Yuzu Miso Cookie", SwingConstants.CENTER);
        lbl9 = new JLabel("Kinako Cookie", SwingConstants.CENTER);
